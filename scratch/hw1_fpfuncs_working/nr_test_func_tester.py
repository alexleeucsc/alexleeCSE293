...
for cycle in range(100):
    ...
    # rand_flt_a = 6.409500242469818
    # rand_flt_b = 14.416229729992542
    a_sign = 1
    b_sign = 1
    ...
    print("1 state = " + str(sim.inspect("state")))
    for cycle in range(15):
        ...
        print("2 state = " + str(sim.inspect("state")))
        ...
        print("-----MULT OUTPUT-----")
        print("\tvalu of 'float_A_reg' was: " + str(binWireToFloat(float_A_reg_registers, expLen+manLen+1)))
        print("\tvalu of 'float_C' was: " + str(binWireToFloat(float_C, expLen+manLen+1)))
        print("\n")
    ...
    if abs(float_C_outputfloat-pyOut)>=1:
        print("testcase", rand_flt_a, rand_flt_b, pyOut, float_C_outputfloat)
    ...
    print("3 state = " + str(sim.inspect("state")))
    print("\n")
    print("\n")
    print("\n")
